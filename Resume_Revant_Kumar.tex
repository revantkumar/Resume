...
\vspace{-2pt}
\area{Selected Coursework:}{Machine Learning {\tiny$\bullet$} Data and Visual Analytics {\tiny$\bullet$} Algorithms {\tiny$\bullet$} Social Computing {\tiny$\bullet$}  Deep Learning for Perception* {\tiny$\bullet$}  Advanced Internet Computing* {\tiny$\bullet$} Web Search \& Text Mining* \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (* -- Current Courses)} %going to take in Spring'15)}
...
\item Familiarity with Matlab, SQLite, D3.js, Gephi, Tableau, HTML, Javascript, CSS, Git, \LaTeX, Octave, Weka, Hadoop, Pig%, MongoDB, Robomongo, Hadoop, Pig
